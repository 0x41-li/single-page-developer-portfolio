  ...
  return (
    <section className="mt-20  md:mt-[60px] xl:mt-[104px]">
      <div className="relative mx-auto max-w-[1100px]">
        ...
        <div className="mx-auto flex max-w-[345px] flex-col gap-6 border-y py-10 text-center md:max-w-[708px] md:flex-row md:flex-wrap md:gap-0 md:gap-x-[7px] md:gap-y-[52px] md:border-b-0 md:py-[52px] xl:max-w-none xl:gap-x-[30px] xl:gap-y-[58px] xl:pt-[72px]">
